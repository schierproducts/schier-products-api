...
use \SchierProducts\SchierProductApi;
 ...
 * @property array|InventoryItem[] $data
 */
class Collection extends InventoryItem implements \Countable, \IteratorAggregate
{
    const OBJECT_NAME = 'list';

    use \SchierProducts\SchierProductApi\Operations\Request;
    ...
    /**
     * @return InventoryItem[]|mixed|null
     */
    ...
    public function all($params = null, $opts = null)
    {
        ...
        $obj = SchierProductApi\Utilities\Utilities::convertToInventoryItem($response, $opts);
        if (!($obj instanceof Collection)) {
            throw new SchierProductApi\Exception\UnexpectedValueException(
    ...
    public function create($params = null, $opts = null)
    {
        ...
        return SchierProductApi\Utilities\Utilities::convertToInventoryItem($response, $opts);
    }
    ...
    public function retrieve($id, $params = null, $opts = null)
    {
        ...
        $id = SchierProductApi\Utilities\Utilities::utf8($id);
        $extn = \urlencode($id);
    ...
    /**
     * @return \Generator|InventoryItem[] A generator that can be used to
